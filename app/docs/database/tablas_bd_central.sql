...
-- DESCRIPCIÃ“N: Estructura completa de tablas que deben crearse en BD CENTRAL
...
-- ============================================================================
-- SECCIÃ“N 1: ADMINISTRACIÃ“N DE CLIENTES
-- ============================================================================
...
-- ============================================================================
-- SECCIÃ“N 2: CATÃLOGO DE MÃ“DULOS ERP
-- ============================================================================
...
-- ============================================================================
-- SECCIÃ“N 3: TABLAS OPERATIVAS (Para clientes con tipo_instalacion = 'shared')
-- ============================================================================
-- NOTA: Estas tablas tambiÃ©n existen en BD dedicada para clientes con BD propia.
...
CREATE TABLE usuario_rol (
    ...
    cliente_id UNIQUEIDENTIFIER NOT NULL,                      -- Desnormalizado para queries rÃ¡pidas
    empresa_id UNIQUEIDENTIFIER NULL,
...
-- Ãndices para tablas operativas
...
-- ============================================================================
-- SECCIÃ“N 4: AUDITORÃA Y SINCRONIZACIÃ“N
-- ============================================================================
