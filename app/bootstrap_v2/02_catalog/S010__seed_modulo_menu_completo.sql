...
('E1000001-0000-4000-8000-000000000001', 'ORG', 'Organización', 'Mi Empresa, Sucursales, Departamentos, Cargos, Centros de Costo, Parámetros', 'building2', '#1976D2', 'operaciones', 1, 0, 1, 1),
('E1000002-0000-4000-8000-000000000002', 'INV', 'Inventarios', 'Productos, Categorías, Unidades, Almacenes, Stock, Movimientos, Inventario Físico', 'FilePen', '#4CAF50', 'operaciones', 0, 1, 2, 1),
...
('E2000001-0000-4000-8000-000000000001', 'E1000001-0000-4000-8000-000000000001', 'PRINCIPAL', 'Principal', 'Opciones del módulo Organización', 'house', 1, 1, 1),
...
('E3010001-0000-4000-8000-000000000001', 'E1000001-0000-4000-8000-000000000001', 'E2000001-0000-4000-8000-000000000001', NULL, 'ORG_MI_EMPRESA', 'Mi Empresa', 'Ver y editar datos de la empresa (RUC, razón social, logo, moneda)', 'house', '/org/empresa', NULL, 1, 'pantalla', 1, 1, 1, 1, 1),
('E3010002-0000-4000-8000-000000000002', 'E1000001-0000-4000-8000-000000000001', 'E2000001-0000-4000-8000-000000000001', NULL, 'ORG_SUCURSALES', 'Sucursales', 'Gestionar sucursales con dirección, teléfono, responsable', 'building', '/org/sucursales', NULL, 1, 'pantalla', 2, 1, 1, 1, 1),
('E3010003-0000-4000-8000-000000000003', 'E1000001-0000-4000-8000-000000000001', 'E2000001-0000-4000-8000-000000000001', NULL, 'ORG_DEPARTAMENTOS', 'Departamentos', 'Crear estructura organizacional jerárquica por áreas', 'warehouse', '/org/departamentos', NULL, 1, 'pantalla', 3, 1, 1, 1, 1),
('E3010004-0000-4000-8000-000000000004', 'E1000001-0000-4000-8000-000000000001', 'E2000001-0000-4000-8000-000000000001', NULL, 'ORG_CARGOS', 'Cargos', 'Definir puestos de trabajo (gerente, operario, vendedor, etc.)', 'user', '/org/cargos', NULL, 1, 'pantalla', 4, 1, 1, 1, 1),
('E3010005-0000-4000-8000-000000000005', 'E1000001-0000-4000-8000-000000000001', 'E2000001-0000-4000-8000-000000000001', NULL, 'ORG_CENTROS_COSTO', 'Centros de Costo', 'Configurar centros para control de gastos por área', 'wallet', '/org/centros-costo', NULL, 1, 'pantalla', 5, 1, 1, 1, 1),
...
-- ----- INV (9 ítems) -----
INSERT INTO modulo_menu (menu_id, modulo_id, seccion_id, cliente_id, codigo, nombre, descripcion, icono, ruta, menu_padre_id, nivel, tipo_menu, orden, requiere_autenticacion, es_visible, es_menu_sistema, es_activo) VALUES
('E3020001-0000-4000-8000-000000000001', 'E1000002-0000-4000-8000-000000000002', 'E2000002-0000-4000-8000-000000000002', NULL, 'INV_CATEGORIAS', 'Categorías', 'Organizar productos en categorías y subcategorías', 'layers', '/inv/categorias', NULL, 1, 'pantalla', 1, 1, 1, 1, 1),
('E3020002-0000-4000-8000-000000000002', 'E1000002-0000-4000-8000-000000000002', 'E2000002-0000-4000-8000-000000000002', NULL, 'INV_UNIDADES', 'Unidades de Medida', 'Gestionar UND, KG, MT, LT con factores de conversión', 'ruler', '/inv/unidades-medida', NULL, 1, 'pantalla', 2, 1, 1, 1, 1),
('E3020003-0000-4000-8000-000000000003', 'E1000002-0000-4000-8000-000000000002', 'E2000002-0000-4000-8000-000000000002', NULL, 'INV_PRODUCTOS', 'Productos', 'Catálogo completo con SKU, código de barras, categoría, precio', 'LayoutList', '/inv/productos', NULL, 1, 'pantalla', 3, 1, 1, 1, 1),
...
('E3020005-0000-4000-8000-000000000005', 'E1000002-0000-4000-8000-000000000002', 'E2000002-0000-4000-8000-000000000002', NULL, 'INV_TIPOS_MOV', 'Tipos de Movimiento', 'Definir tipos: compra, venta, ajuste, transferencia', 'ArrowLeftRight', '/inv/tipos-movimiento', NULL, 1, 'pantalla', 5, 1, 1, 1, 1),
('E3020006-0000-4000-8000-000000000006', 'E1000002-0000-4000-8000-000000000002', 'E2000002-0000-4000-8000-000000000002', NULL, 'INV_MOVIMIENTOS', 'Movimientos de Inventario', 'Registrar entradas, salidas, transferencias', 'FileSliders', '/inv/movimientos', NULL, 1, 'pantalla', 6, 1, 1, 1, 1),
('E3020007-0000-4000-8000-000000000007', 'E1000002-0000-4000-8000-000000000002', 'E2000002-0000-4000-8000-000000000002', NULL, 'INV_INV_FISICO', 'Inventario Físico', 'Toma de inventario y ajuste de diferencias', 'UserPen', '/inv/inventario-fisico', NULL, 1, 'pantalla', 7, 1, 1, 1, 1),
('E3020008-0000-4000-8000-000000000008', 'E1000002-0000-4000-8000-000000000002', 'E2000002-0000-4000-8000-000000000002', NULL, 'INV_STOCK', 'Consulta de Stock', 'Ver stock actual, reservado y disponible por almacén', 'FileChartLine', '/inv/stock', NULL, 1, 'pantalla', 8, 1, 1, 1, 1),
('E3020009-0000-4000-8000-000000000009', 'E1000002-0000-4000-8000-000000000002', 'E2000002-0000-4000-8000-000000000002', NULL, 'INV_INV_KARDEX', 'Kardex', 'Kardex', 'FileSpreadsheet', '/inv/kardex', NULL, 1, 'pantalla', 9, 1, 1, 1, 1);
