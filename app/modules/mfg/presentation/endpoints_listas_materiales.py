...
@router.get(
    "",
    response_model=List[ListaMaterialesRead],
    tags=["MFG - Listas de Materiales (BOM)"],
    dependencies=[Depends(require_permission("mfg.lista_materiales.leer"))],
)
...
@router.post(
    ...
    tags=["MFG - Listas de Materiales (BOM)"],
    dependencies=[Depends(require_permission("mfg.lista_materiales.crear"))],
)
...
@router.put(
    ...
    response_model=ListaMaterialesRead,
    tags=["MFG - Listas de Materiales (BOM)"],
    dependencies=[Depends(require_permission("mfg.lista_materiales.actualizar"))],
)
