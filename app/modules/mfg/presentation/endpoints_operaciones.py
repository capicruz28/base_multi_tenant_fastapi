...
@router.get(
    "",
    response_model=List[OperacionRead],
    tags=["MFG - Operaciones"],
    dependencies=[Depends(require_permission("mfg.operacion.leer"))],
)
...
@router.post(
    ...
    tags=["MFG - Operaciones"],
    dependencies=[Depends(require_permission("mfg.operacion.crear"))],
)
...
@router.put(
    ...
    response_model=OperacionRead,
    tags=["MFG - Operaciones"],
    dependencies=[Depends(require_permission("mfg.operacion.actualizar"))],
)
