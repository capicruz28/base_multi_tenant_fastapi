...
@router.get(
    "",
    response_model=List[ListaMaterialesDetalleRead],
    tags=["MFG - BOM Detalle"],
    dependencies=[Depends(require_permission("mfg.lista_materiales_detalle.leer"))],
)
...
@router.get(
    "/{bom_detalle_id}",
    response_model=ListaMaterialesDetalleRead,
    tags=["MFG - BOM Detalle"],
    dependencies=[Depends(require_permission("mfg.lista_materiales_detalle.leer"))],
)
...
@router.post(
    ...
    tags=["MFG - BOM Detalle"],
    dependencies=[Depends(require_permission("mfg.lista_materiales_detalle.crear"))],
)
...
@router.put(
    ...
    response_model=ListaMaterialesDetalleRead,
    tags=["MFG - BOM Detalle"],
    dependencies=[Depends(require_permission("mfg.lista_materiales_detalle.actualizar"))],
)
