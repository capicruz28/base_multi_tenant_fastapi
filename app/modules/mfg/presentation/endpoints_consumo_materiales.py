...
@router.get(
    "",
    response_model=List[ConsumoMaterialesRead],
    tags=["MFG - Consumo Materiales"],
    dependencies=[Depends(require_permission("mfg.consumo_material.leer"))],
)
...
@router.get(
    "/{consumo_id}",
    response_model=ConsumoMaterialesRead,
    tags=["MFG - Consumo Materiales"],
    dependencies=[Depends(require_permission("mfg.consumo_material.leer"))],
)
...
@router.post(
    ...
    tags=["MFG - Consumo Materiales"],
    dependencies=[Depends(require_permission("mfg.consumo_material.crear"))],
)
...
@router.put(
    ...
    response_model=ConsumoMaterialesRead,
    tags=["MFG - Consumo Materiales"],
    dependencies=[Depends(require_permission("mfg.consumo_material.actualizar"))],
)
