...
@router.get(
    "",
    response_model=List[RutaFabricacionRead],
    tags=["MFG - Rutas de Fabricación"],
    dependencies=[Depends(require_permission("mfg.ruta_fabricacion.leer"))],
)
...
@router.post(
    ...
    tags=["MFG - Rutas de Fabricación"],
    dependencies=[Depends(require_permission("mfg.ruta_fabricacion.crear"))],
)
...
@router.put(
    ...
    response_model=RutaFabricacionRead,
    tags=["MFG - Rutas de Fabricación"],
    dependencies=[Depends(require_permission("mfg.ruta_fabricacion.actualizar"))],
)
