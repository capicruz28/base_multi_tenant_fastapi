...
@router.get(
    "",
    response_model=List[RutaFabricacionDetalleRead],
    tags=["MFG - Ruta Fabricación Detalle"],
    dependencies=[Depends(require_permission("mfg.ruta_fabricacion_detalle.leer"))],
)
...
@router.get(
    "/{ruta_detalle_id}",
    response_model=RutaFabricacionDetalleRead,
    tags=["MFG - Ruta Fabricación Detalle"],
    dependencies=[Depends(require_permission("mfg.ruta_fabricacion_detalle.leer"))],
)
...
@router.post(
    ...
    tags=["MFG - Ruta Fabricación Detalle"],
    dependencies=[Depends(require_permission("mfg.ruta_fabricacion_detalle.crear"))],
)
...
@router.put(
    ...
    response_model=RutaFabricacionDetalleRead,
    tags=["MFG - Ruta Fabricación Detalle"],
    dependencies=[Depends(require_permission("mfg.ruta_fabricacion_detalle.actualizar"))],
)
