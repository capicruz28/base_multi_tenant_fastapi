...
async def list_departamentos(
    ...
    return await CatalogosService.list_departamentos(client_id=current_user.cliente_id, pais_id=pais_id)
...
async def list_provincias(
    ...
    return await CatalogosService.list_provincias(client_id=current_user.cliente_id, departamento_id=departamento_id)
