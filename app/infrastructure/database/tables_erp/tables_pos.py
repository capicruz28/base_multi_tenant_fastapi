...
PosTurnoCajaTable = Table(
    ...
    Column("diferencia", Numeric(18, 2), nullable=True),
    Column("total_ingresos", Numeric(18, 2), nullable=True),
...
PosVentaTable = Table(
    ...
    Column("moneda_id", UNIQUEIDENTIFIER, ForeignKey("cat_moneda.moneda_id", ondelete="NO ACTION"), nullable=True),
    ...
    Column("total_cobrar", Numeric(18, 2), nullable=True),
    Column("monto_cambio", Numeric(18, 2), nullable=True),
...
PosVentaDetalleTable = Table(
    ...
    Column("descuento_monto", Numeric(18, 4), nullable=True),
    Column("precio_neto", Numeric(18, 4), nullable=True),
    Column("subtotal", Numeric(18, 2), nullable=True),
    Column("igv", Numeric(18, 2), nullable=True),
    Column("total", Numeric(18, 2), nullable=True),
