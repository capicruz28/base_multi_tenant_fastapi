...
MfgOrdenProduccionTable = Table(
    ...
    Column("cantidad_pendiente", Numeric(18, 4), nullable=True),
    Column("unidad_medida_id", UNIQUEIDENTIFIER, ForeignKey("inv_unidad_medida.unidad_medida_id"), nullable=False),
    ...
    Column("costo_total", Numeric(18, 2), nullable=True),
    Column(
        "moneda_id",
        UNIQUEIDENTIFIER,
...
MfgConsumoMaterialesTable = Table(
    ...
    Column("diferencia", Numeric(18, 4), nullable=True),
    Column("unidad_medida_id", UNIQUEIDENTIFIER, ForeignKey("inv_unidad_medida.unidad_medida_id"), nullable=False),
    ...
    Column("costo_total", Numeric(18, 4), nullable=True),
