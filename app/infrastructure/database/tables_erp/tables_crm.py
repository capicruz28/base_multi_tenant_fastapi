...
CrmActividadTable = Table(
    ...
    Column("descripcion", Text, nullable=True),
    Column("lead_id", UNIQUEIDENTIFIER, ForeignKey("crm_lead.lead_id", ondelete="NO ACTION"), nullable=True),
    Column("oportunidad_id", UNIQUEIDENTIFIER, ForeignKey("crm_oportunidad.oportunidad_id", ondelete="NO ACTION"), nullable=True),
    Column("cliente_venta_id", UNIQUEIDENTIFIER, ForeignKey("sls_cliente.cliente_venta_id", ondelete="NO ACTION"), nullable=True),
